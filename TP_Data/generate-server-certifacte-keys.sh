...
openssl req -out TP_Data/2_IstioInAction/2.1_Gateway/cert/client.formation.io.csr -newkey rsa:2048 -nodes -keyout TP_Data/2_IstioInAction/2.1_Gateway/cert/client.formation.io.key -subj "/CN=client.formation.io/O=client organization"
openssl x509 -req -sha256 -days 365 -CA TP_Data/2_IstioInAction/2.1_Gateway/cert/formation.io.crt -CAkey TP_Data/2_IstioInAction/2.1_Gateway/cert/formation.io.key -set_serial 1 -in TP_Data/2_IstioInAction/2.1_Gateway/cert/client.formation.io.csr -out TP_Data/2_IstioInAction/2.1_Gateway/cert/client.formation.io.crt
